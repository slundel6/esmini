...
macro(set_cloud_links)
    ...
    if(APPLE)
        ...
        if(DEFINED OSI_TAG_URL)
            set(OSI_PACKAGE_URL
                https://github.com/slundel6/esmini-sandbox/releases/download/${OSI_TAG_URL}/osi-macos.tar.xz)
        endif()
    ...
    elseif(LINUX)
        ...
        if(DEFINED OSI_TAG_URL)
            set(OSI_PACKAGE_URL
                https://github.com/slundel6/esmini-sandbox/releases/download/${OSI_TAG_URL}/osi-linux.tar.xz)
        endif()
        set(SUMO_PACKAGE_URL
    ...
    elseif(MSVC)
        ...
        if(DEFINED OSI_TAG_URL)
            set(OSI_PACKAGE_URL
                https://github.com/slundel6/esmini-sandbox/releases/download/${OSI_TAG_URL}/osi-windows.tar.xz)
        endif()
        set(SUMO_PACKAGE_URL
