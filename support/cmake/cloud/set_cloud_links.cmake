...
macro(set_cloud_links)
    ...
    if(APPLE)
        ...
        set(OSI_PACKAGE_URL
            https://github.com/slundel6/esmini-sandbox/releases/download/v3.5.0_2/osi-macos.tar.xz)
    ...
    elseif(LINUX)
        ...
        set(OSI_PACKAGE_URL
            https://github.com/slundel6/esmini-sandbox/releases/download/v3.5.0_2/osi-linux.tar.xz)
        set(SUMO_PACKAGE_URL
    ...
    elseif(MSVC)
        ...
        set(OSI_PACKAGE_URL
            https://github.com/slundel6/esmini-sandbox/releases/download/v3.5.0_2/osi-windows.tar.xz)
        set(SUMO_PACKAGE_URL
