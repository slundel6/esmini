...
macro(set_cloud_links)
    ...
    if(APPLE)
        ...
        set(OSI_PACKAGE_URL
            https://github.com/slundel6/ci-sandbox/releases/download/${OSI_TAG_URL}/osi-macos.tar.xz)
    ...
    elseif(LINUX)
        ...
        set(OSI_PACKAGE_URL
            https://github.com/slundel6/ci-sandbox/releases/download/${OSI_TAG_URL}/osi-linux.tar.xz)
        set(SUMO_PACKAGE_URL
    ...
    elseif(MSVC)
        ...
        set(OSI_PACKAGE_URL
            https://github.com/slundel6/ci-sandbox/releases/download/${OSI_TAG_URL}/osi-windows.tar.xz)
        set(SUMO_PACKAGE_URL
