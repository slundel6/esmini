...
macro(set_cloud_links)
    ...
    if(APPLE)
        ...
        set(OSI_PACKAGE_URL
            https://github.com/esmini/esmini-dependencies/releases/download/osi-v3.5.0_1/osi-macos.tar.xz)
        ...
        set(IMPLOT_PACKAGE_URL
            https://github.com/esmini/esmini-dependencies/releases/download/implot-v0.16_1/implot-macos.tar.xz)
    elseif(LINUX)
        set(OSG_PACKAGE_URL
        ...
        set(OSI_PACKAGE_URL
            https://github.com/esmini/esmini-dependencies/releases/download/osi-v3.5.0_1/osi-linux.tar.xz)
        set(SUMO_PACKAGE_URL
        ...
        set(IMPLOT_PACKAGE_URL
            https://github.com/esmini/esmini-dependencies/releases/download/implot-v0.16_1/implot-linux.tar.xz)
    elseif(MSVC)
        set(OSG_PACKAGE_URL
        ...
        set(OSI_PACKAGE_URL
            https://github.com/esmini/esmini-dependencies/releases/download/osi-v3.5.0_1/osi-windows.tar.xz)
        set(SUMO_PACKAGE_URL
        ...
        set(IMPLOT_PACKAGE_URL
            https://github.com/esmini/esmini-dependencies/releases/download/implot-v0.16_1/implot-windows.tar.xz)
    elseif(MINGW)
