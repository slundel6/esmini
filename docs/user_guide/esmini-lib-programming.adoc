...
||0.0||0.0|Step(dt=0.0)
||0.0||0.0 a|- start init actions
||0.0||0.0 a|- step default controller (establish initial positions and speed)
||0.0||0.0 a|- evaluate triggers & start triggered actions
...
||0.1||0.1 a|- update actions
||0.1||0.1 a|- step default controller (move entities, except Ego)
||0.1||0.1 a|- evaluate triggers & start triggered actions
...
||0.2||0.2 a|- update actions
||0.2||0.2 a|- step default controller (move entities, except Ego)
||0.2||0.2 a|- evaluate triggers & start triggered actions
