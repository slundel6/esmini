...
From v2.47.0 esmini supports game controllers, allowing interactive control of one or multiple entities in a simulation.
...
.Mapping
++++
<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTIxA9xhO1GomQDd3GvamIaul80S4GLH4UHyWubsG7sm3lLuCMqMo0QcHg-6D-NfKqqFKDwGWa1W_g2/pubhtml?gid=2029882313&amp;single=true&amp;widget=false&amp;headers=false&amp" width="550" height="1540"></iframe>
++++
...
It's a bit tricky to find out ID and mappings. The next section provides some help using common tools.
